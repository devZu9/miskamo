"""
modules/audio2midi/audio2midi.py — голос → инструмент (DDSP) → MIDI

CLI:
  python -c "from modules.audio2midi.audio2midi import MiskamoEngine; ..."
"""
...
ROOT = Path(__file__).resolve().parent.parent.parent / "DDSP-Timbre-Transfer"
